...
declare module '@polkadot/types/types/registry' {
  interface InterfaceTypes {
    ...
    DkgStandaloneRuntimeRuntimeHoldReason: DkgStandaloneRuntimeRuntimeHoldReason;
