...
export const executeBefore = async () => {
	...
	smallZkComponents = await Utility.fetchComponentsFromFilePaths(
		path.resolve(
			gitRoot,
			'dkg-test-suite',
			'solidity-fixtures/fixtures/vanchor_2/2/poseidon_vanchor_2_2.wasm'
		),
		path.resolve(
			gitRoot,
			'dkg-test-suite',
			'solidity-fixtures/fixtures/vanchor_2/2/witness_calculator.cjs'
		),
		path.resolve(
			gitRoot,
			'dkg-test-suite',
			'solidity-fixtures/fixtures/vanchor_2/2/circuit_final.zkey'
		)
	);
	...
	largeZkComponents = await Utility.fetchComponentsFromFilePaths(
		path.resolve(
			gitRoot,
			'dkg-test-suite',
			'solidity-fixtures/fixtures/vanchor_16/2/poseidon_vanchor_16_2.wasm'
		),
		path.resolve(
			gitRoot,
			'dkg-test-suite',
			'solidity-fixtures/fixtures/vanchor_16/2/witness_calculator.cjs'
		),
		path.resolve(
			gitRoot,
			'dkg-test-suite',
			'solidity-fixtures/fixtures/vanchor_16/2/circuit_final.zkey'
		)
	);
