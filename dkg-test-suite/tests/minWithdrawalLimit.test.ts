...
import { executeAfter, executeBefore, localChain, polkadotApi, signatureVBridge } from './utils/util';
...
it('should be able to update min withdrawal limit', async () => {
  ...
  await waitForEvent(polkadotApi, 'dKGProposalHandler', 'ProposalSigned', { key: 'MinWithdrawalLimitUpdateProposal' });
