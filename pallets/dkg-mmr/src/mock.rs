...
pub type MmrLeaf = dkg_runtime_primitives::mmr::MmrLeaf<
...
impl pallet_dkg_mmr::ParachainHeadsProvider for DummyParaHeads {
	fn parachain_heads() -> Vec<(pallet_dkg_mmr::ParaId, pallet_dkg_mmr::ParaHead)> {
