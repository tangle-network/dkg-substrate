...
impl<T: frame_system::Config> WeightInfo for WebbWeight<T> {
	...
	fn submit_public_key(n: u32, ) -> Weight {
		(0 as Weight)
			// Standard Error: 6_642_000
			.saturating_add((462_763_000 as Weight).saturating_mul(n as Weight))
	...
	fn submit_next_public_key(n: u32, ) -> Weight {
		(0 as Weight)
			// Standard Error: 6_590_000
			.saturating_add((462_850_000 as Weight).saturating_mul(n as Weight))
			.saturating_add(T::DbWeight::get().reads(4 as Weight))
			.saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
	// Storage: DKG NextDKGPublicKey (r:1 w:1)
	...
	fn submit_misbehaviour_reports(n: u32, ) -> Weight {
		(0 as Weight)
			// Standard Error: 6_610_000
			.saturating_add((461_467_000 as Weight).saturating_mul(n as Weight))
