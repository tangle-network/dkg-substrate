...
/// but the amount for the nomination is MinNominatorStk << MinCollatorStk =>
/// the rest + extra is free balance for the returned account.
...
/// Create a funded collator. Base amount is MinCollatorStk == default_balance
/// but the last parameter `extra` represents how much additional balance is
/// minted to the collator.
