...
//! DKG + MMR utilties.
//!
//! While DKG can be used completely indepentently as an additional consensus gadget,
...
//! used in conjunction with DKG, to be able to efficiently prove any past blockchain data.
//!
//! This module contains primitives used by Polkadot implementation of the DKG+MMR bridge,
...
pub struct DKGNextAuthoritySet<MerkleRoot> {
	...
	pub id: crate::AuthoritySetId,
	/// Number of validators in the set.
	///
	/// Some DKG Light Clients may use an interactive protocol to verify only subset
	/// of signatures. We put set length here, so that these clients can verify the minimal
	/// number of required signatures.
	pub len: u32,
	/// Merkle Root Hash build from DKG AuthorityIds.
	///
