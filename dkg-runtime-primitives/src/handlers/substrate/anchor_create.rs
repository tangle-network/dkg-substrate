...
pub struct AnchorCreateProposal<C: ChainIdTrait> {
...
pub fn create<C: ChainIdTrait>(data: &[u8]) -> Result<AnchorCreateProposal<C>, ValidationError> {
	...
	Ok(AnchorCreateProposal { header, encoded_call })
}
