...
// };
// use dkg_runtime_primitives::{crypto::Public, UnsignedProposal, MAX_PROPOSAL_LENGTH};
...
// 	Arc<Mutex<HashMap<BatchKey, Vec<(Proposal<MAX_PROPOSAL_LENGTH>, SignatureRecid, BigInt)>>>>;
